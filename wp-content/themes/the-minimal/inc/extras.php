...
function the_minimal_footer_credit(){
	...
	$text .= '<a href="' . esc_url( 'https://raratheme.com/wordpress-themes/the-minimal/' ) .'" rel="author" target="_blank">' . esc_html__( 'The Minimal by: Rara Theme', 'the-minimal' ) . '</a> &middot; ';
